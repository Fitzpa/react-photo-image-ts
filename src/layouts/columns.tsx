...
export const computeColumnLayout = ({ photos, columns, containerWidth, margin }:{ photos:IPhoto[], columns:number, containerWidth:number, margin:number }) => {
  ...
  const colLeftPositions:Array<any> = [];
  const colCurrTopPositions:Array<any> = [];
